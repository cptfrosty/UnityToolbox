...
| Time |  Момент, когда произойдет выброс, в секундах от начала цикла системы. |
| Count | Сколько частиц будет выброшено. Можно задать константу, случайное значение между двумя константами или кривую |
| Cycles | Сколько раз повторить этот выброс. По умолчанию 1 (один раз). |
| Interval | Если Cycles больше 1, это поле определяет паузу (в секундах) между повторяющимися выбросами. |
| Probability | Шанс, что выброс вообще произойдет. 1.0 = 100% шанс, 0.5 = 50% шанс. |
